...
<div class="playlist-related-recommend__container">
  ...
  <div class="playlist-related-recommend__block">
    ...
    >
      <img :src="item.coverImgUrl" class="playlist-related-recommend__block--item-img">
      <div class="playlist-related-recommend__block--item-content">
        <h2 class="playlist-related-recommend__block--item-content-name ellipsis">{{item.name}}</h2>
        <span class="playlist-related-recommend__block--item-content-creator">By. {{item.creator.nickname}}</span>
      </div>
    </div>
  </div>
